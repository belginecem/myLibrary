    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="padding:80px;">
          ...
          <h2>Authors</h2>
          <button type="submit" class= "btn" onclick="location.href ='/Admin/new_author'"><span data-feather="plus-circle"></span> Add Author</button>
            ...
            <table class="table table-striped table-sm">
              ...
              <?php foreach($authors as $val){ ?>
                <tr>
                  ...
                  <td>
                    <a type="submit" class="btn btn-danger" href="/Admin/delete_author/<?php echo $val->id;?>"><span data-feather="trash-2"></span></a>
                  </td>
                </tr>
              <?php } ?>
              </tbody>
